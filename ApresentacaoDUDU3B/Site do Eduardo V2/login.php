...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email || !$password) {
        ...
        $sql = "SELECT id, name, password FROM users WHERE email = '$emailEscaped'";
...
<html lang="pt-br">
  <head>
    ...
    <!-- Seção de Login -->
    <section id="login" class="min-vh-100 d-flex align-items-center">
      <div class="container">
            ...
            <div class="card shadow-lg p-4 rounded-5">
              ...
              <form method="POST" action="login.php">
                ...
                <div class="text-center">
                  <p class="text-muted">
                    Não tem uma conta?
                    <a href="registro.php" class="text-primary">Registre-se</a>
                  </p>
                </div>
              </form>
            </div>
